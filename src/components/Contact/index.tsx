			...
			<TagsContent>
				<div className={styles.contactForm}>
					<div className={styles.description} data-testid="animated-letters">
						...
						<p data-testid="info">
							I want to develop web and mobile apps so that I can use my creativity and tech skills to bring people together for a
							special experience and help organizations attract and engage new customers
						</p>
					</div>
